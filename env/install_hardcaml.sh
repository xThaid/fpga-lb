...
apt-get install -y unzip build-essential gcc curl coreutils libgmp-dev
...
su user -c "opam install -y utop hardcaml hardcaml_waveterm ppx_deriving_hardcaml dune hardcaml_step_testbench"
